...
>
> ✅ **Phase 2（值班排班）已实现（2026-05-18）** —— `SupervisorShift` 两表加 `provider_id` + 4 个 `/supervisor/shifts` 端点 scope-aware + nav 补值班排班。详见 `2026-05-18-provider-supervisor-phase2-shifts-design.md`。
