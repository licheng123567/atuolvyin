  ...
  return (
    <div className="p-6">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="text-xl font-semibold text-[var(--color-neutral-900)]">合规月报</h1>
          ...
          <tbody className="divide-y divide-[var(--color-neutral-100)]">
            ...
            {items.map((it) => (
              <tr
                ...
                onClick={() => go({ to: `/admin/compliance/${it.year_month}` })}
              >
