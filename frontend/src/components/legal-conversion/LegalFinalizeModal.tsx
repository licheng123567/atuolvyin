...
//
// v0.5.8 — 从中间 Modal 迁移到 RightDrawer(决策矩阵:表单 ≥ 4 字段 + 需边看
// 服务包列表上下文 + 案件信息);详见 docs/UI_PATTERNS_MODAL.md
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    {p.description && (
                      <div className="text-xs text-[var(--color-neutral-600)] mt-0.5 whitespace-pre-wrap">
                        {p.description}
                      </div>
                    )}
                  </div>
