...
public final class ItemTaskBinding implements ViewBinding {
  ...
  private ItemTaskBinding(@NonNull LinearLayout rootView, @NonNull Button btnCall,
      @NonNull TextView sub, @NonNull TextView title) {
  ...
  public static ItemTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTaskBinding((LinearLayout) rootView, btnCall, sub, title);
    }
